...
// Paths always excluded regardless of .droidlane-ignore
const HARDCODED_EXCLUDED_PATHS = ['app/build'];
...
function shouldExclude(relPath, name, isDir) {
  ...
  for (const ex of HARDCODED_EXCLUDED_PATHS) {
...
module.exports = { loadIgnore, shouldExclude, walkTree, EXCLUDED_NAMES, EXCLUDED_PATHS, HARDCODED_EXCLUDED_PATHS };
